...
public class QueueDaoImpl implements QueueDao {
    ...
    @Value("${spring.rabbitmq.evdbelge.hedef.routingKey}")
    private String ebhRoutingkey;
    ...
    @Override
    public void pushHedefQueue(JsonObject jsondata) {
        JsonObject jsonObj = new JsonObject();
        jsonObj.add("jsonData", jsondata);
        jsonObj.addProperty("optime", DateUtils.getDateTime());
        rabbitTemplate.convertAndSend(exchange, ebhRoutingkey, jsonObj.toString());
    }
