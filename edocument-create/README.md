...
http://git.gelbim.gov.tr/EVDB/evdbelge/evdbelge-hazirlama
...
http://localhost:8070/evdb/evdbelge/hazirlama-server/swagger-ui/index.html#/
veya
http://localhost:8070/evdb/evdbelge/hazirlama-server/api
...
```text
HAZIRLAMA_SERVER_PORT=8070;

SVR_CONTEXT_PATH=/evdb/evdbelge/hazirlama-server;
LOG_PATH=evdbelge-hazirlama;
ENVIRONMENT=TEST;
...
SERVICE_URL=http://localhost:8070/evdb/evdbelge/hazirlama-server;
...
RABBITMQ_API_QUEUE_URL=http://10.251.55.91:15672/api/queues/%2f/evdbelgeAktarim;
RABBITMQ_API_TOKEN=Basic dGVzdDp0ZXN0XzEyMzQ=;
