package tr.gov.gib.evdbelge.evdbelgepdfolusturma.external.service.impl;
...
import tr.gov.gib.evdbelge.evdbelgepdfolusturma.external.service.YevdoExternalService;
import tr.gov.gib.evdbelge.evdbelgepdfolusturma.external.service.enums.EnumEVDO;
...
public class YevdoExternalServiceImpl implements YevdoExternalService, EnumEVDO {
    ...
    public JsonObject islenmisBelgeBildir(Belge belge) throws GibException {
        ...
        try {
            return remoteCallService.remoteCall(IslenmisBelgeleriBildir.INPUT.RC_SERVICE_NAME.value(), rcInp)
