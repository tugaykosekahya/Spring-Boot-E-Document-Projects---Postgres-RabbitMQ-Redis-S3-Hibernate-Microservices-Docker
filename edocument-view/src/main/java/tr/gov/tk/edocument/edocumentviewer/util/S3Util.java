package tr.gov.gib.evdbelge.evdbelgegoruntuleme.util;
...
//    public static void dosyaYukleS3(String bucketName, String fileName, byte[] obj) throws Exception {
//        ObjectMetadata metadata = new ObjectMetadata();
//        metadata.setContentLength(obj.length);
//        PutObjectRequest request = new PutObjectRequest(bucketName, fileName, new ByteArrayInputStream(obj), metadata);
//        PutObjectResult putResult = getS3AccessObject().putObject(request);
//        if (putResult == null)
//            throw new Exception("Failed to write " + fileName + " keyed file to object storage.");
//    }
